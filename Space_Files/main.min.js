...
function goToScenario(t) {
    if ($(".mainnav-a").removeClass("is-active"),
    $(".mainnav-li:nth-child(" + t + ") .mainnav-a").addClass("is-active"),
...
$(".pane--main").mouseenter(function() {
    $(this).hasClass("pane--step-1") && !$(".main").hasClass("main--scenario-1") ? $(".mainnav-li:nth-child(1) .mainnav-a").addClass("is-highlighted") : $(this).hasClass("pane--step-2") && !$(".main").hasClass("main--scenario-2") ? $(".mainnav-li:nth-child(2) .mainnav-a").addClass("is-highlighted") : $(this).hasClass("pane--step-3") && !$(".main").hasClass("main--scenario-3") ? $(".mainnav-li:nth-child(3) .mainnav-a").addClass("is-highlighted") : $(this).hasClass("pane--step-4") && !$(".main").hasClass("main--scenario-4") && $(".mainnav-li:nth-child(4) .mainnav-a").addClass("is-highlighted")
}),
$(".pane--main").mouseleave(function() {
    $(".mainnav-a").removeClass("is-highlighted")
}),
$(".navigation__title").click(function(t) {
    isDesktopVersion() && goToScenario(1),
    t.preventDefault()
}),
$(".mainnav-a").click(function(t) {
...
$("body").on("mouseenter", ".mainnav-a:not(.is-active), .share-list__item__button, .main--scenario-1 .pane--main:not(.pane--step-1), .main--scenario-2 .pane--main:not(.pane--step-2), .main--scenario-3 .pane--main:not(.pane--step-3), .main--scenario-4 .pane--main:not(.pane--step-4)", function() {
...
$(".navigation__title, .mainnav-toggle").click(function(t) {
    $("body").toggleClass("mainnav-is-active"),
    t.preventDefault()
}),
$(".mainnav-a").click(function() {
    $("body").removeClass("mainnav-is-active")
});
