...
*/
    ...
    q("Map", function(a) {
        ...
        function d(h, k) {
            var m = k && typeof k;
            "object" == m || "function" == m ? f.has(k) ? m = f.get(k) : (m = "" + ++g,
            f.set(k, m)) : m = "p_" + k;
            var p = h.b[m];
            if (p && t(h.b, m))
    ...
    q("Reflect.set", function(a) {
        return a ? a : function(b, c, d, e) {
            var f = ra(b, c);
            return f ? f.set ? (f.set.call(3 < arguments.length ? e : b, d),
            !0) : f.writable && !Object.isFrozen(b) ? (b[c] = d,
    ...
    ;function db(a, b) {
        a.src = Pa(b);
        (b = a.ownerDocument && a.ownerDocument.defaultView) && b != w ? b = va(b.document) : (null === ua && (ua = va(w.document)),
        b = ua);
    ...
    ;var gb = M("Opera"), hb = M("Trident") || M("MSIE"), ib = M("Edge"), jb = M("Gecko") && !(-1 != L.toLowerCase().indexOf("webkit") && !M("Edge")) && !(M("Trident") || M("MSIE")) && !M("Edge"), kb = -1 != L.toLowerCase().indexOf("webkit") && !M("Edge"), lb;
    a: {
        var mb = ""
          , nb = function() {
            var a = L;
    ...
    function Hb() {
        if (w.Promise && w.Promise.resolve) {
            ...
            Gb = function() {
                var b = Jb;
                !B(w.setImmediate) || w.Window && w.Window.prototype && !M("Edge") && w.Window.prototype.setImmediate == w.setImmediate ? (yb || (yb = zb()),
                yb(b)) : w.setImmediate(b)
            }
    }
    var Ib = !1
      , Eb = new Ab;
    ...
    function Pb(a, b) {
        if (0 == a.a)
            if (a.c) {
                var c = a.c;
                if (c.b) {
                    for (var d = 0, e = null, f = null, g = c.b; g && (g.h || (d++,
                    g.a == a && (e = g),
                    !(e && 1 < d))); g = g.next)
                        e || (f = g);
                    e && (0 == c.a && 1 == d ? Pb(c, b) : (f ? (d = f,
                    d.next == c.g && (c.g = d),
                    d.next = d.next.next) : Qb(c),
                    Rb(c, e, 3, b)))
                }
                a.c = null
            } else
...
*/
    ...
    Q.prototype.cancel = function(a) {
        if (this.a)
            this.c instanceof Q && this.c.cancel();
        else {
            if (this.b) {
                var b = this.b;
                delete this.b;
        ...
        for (var d = c = !1; a.h.length && !a.j; ) {
            ...
            if (f = a.g ? g : f)
                try {
                    ...
                    a.c = b = h);
                    if (Kb(b) || "function" === typeof w.Promise && b instanceof w.Promise)
                        d = !0,
                        a.j = !0
                } catch (k) {
                    b = k,
    ...
    function jc(a, b) {
        ...
        e.onload = e.onreadystatechange = function() {
            e.readyState && "loaded" != e.readyState && "complete" != e.readyState || (lc(e, c.la || !1, h),
            Zb(g),
            R(g, !0, null))
        }
        ;
    ...
    ;function wc(a) {
        ...
        this.b = a.b,
        zc(this, Ac(a.c)),
        this.h = a.h) : a && (b = String(a).match(uc)) ? (this.i = !1,
        xc(this, b[1] || "", !0),
        this.j = Bc(b[2] || ""),
        this.a = Bc(b[3] || "", !0),
        yc(this, b[4]),
        this.b = Bc(b[5] || "", !0),
        zc(this, b[6] || "", !0),
        this.h = Bc(b[7] || "")) : (this.i = !1,
        this.c = new U(null,this.i))
    }
    ...
    function zc(a, b, c) {
        b instanceof U ? (a.c = b,
        Hc(a.c, a.i)) : (c || (b = Cc(b, Ic)),
        a.c = new U(b,a.i))
    }
    function Bc(a, b) {
    ...
    function Cc(a, b, c) {
        return "string" === typeof a ? (a = encodeURI(a).replace(b, Jc),
    ...
    function Kc(a, b) {
        ...
        a = a.a,
        T(a.b, b) && (delete a.b[b],
        a.c--,
        a.a.length > 2 * a.c && tc(a)))
    }
    function Lc(a, b) {
        V(a);
        b = W(a, b);
    ...
    function Pc() {
        Y = X = "";
        Nc = Z = Mc = null;
        y("google.load") || (D("google.load", Qc),
        D("google.setOnLoadCallback", J.R));
